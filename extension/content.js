...
function getDetailJob() {
  ...
  if (host.includes('linkedin.com')) {
    ...
    title = qText(document,['h1.job-header-title', '.job-header-title', '#pretty-job-title', 'h1', '.job-details-title']);
    company = qText(document,['.job-details-agency', '.agency', '.department', '.job-header-content']);
    location = qText(document,['.job-details-location', '.location']);
    container = qFirst(document,['h1.job-header-title', '.job-header-title', 'h1', '.job-details-title'])?.parentElement;
    description = qText(document,['#details-info', '.job-details-content', '#job-details-content', '.job-description', '.summary']);
  }
